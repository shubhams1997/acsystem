...
//      var obj = data;
     for(let index in obj.countries)
{
    $("#inputCountry").append('<option value='+obj.countries[index].id+'>'+obj.countries[index].name+'</option>');
}
// });
function loadstates(){
    ...
    //     var st = data;
        ...
        for(let index in st.states)
        {
            if(st.states[index].country_id == countery)
            {
                console.log(st.states[index].id);
                $("#inputState").append('<option value='+st.states[index].id+'>'+st.states[index].name+'</option>');
            }
        }
    // });
}
